...
let col = ["beige","beige","beige"];
let colors = ["#ABD551","#72C8F8","#CC0000","#B29675","#C887FB"];
let symbols = ["+", "≡", "×", "="];
let rectWidth = 600;
let rectHeight = 700;
let boxSize = 100;
...
function setup() {
  ...
  rectX = width / 2; // Set rectX to the center of the canvas
  rectY = height / 2; // Set rectY to the center of the canvas
